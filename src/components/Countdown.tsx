...
export const Countdown: React.FC<CountdownProps> = ({ alarmState }) => {
	...
	return (
		<Card className="bg-gradient-to-br from-red-50 to-orange-50 dark:from-red-900/20 dark:to-orange-900/20 border-2 border-red-200 dark:border-red-800 shadow-2xl mb-6 relative overflow-hidden">
			...
			<CardContent className="p-8 text-center relative z-10">
				...
				<div className="text-5xl font-mono font-bold text-red-800 dark:text-red-200 mb-6 drop-shadow-sm tracking-wider">
				...
				<Badge
					variant="secondary"
					className="bg-red-100/80 dark:bg-red-900/80 text-red-700 dark:text-red-200 border-red-200 dark:border-red-700 hover:bg-red-200/80 dark:hover:bg-red-800/80 text-sm px-6 py-3 rounded-full shadow-lg"
				>
					Hacia las{" "}
